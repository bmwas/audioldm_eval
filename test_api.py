...
It creates sample audio files and tests all available endpoints.
"""
...
# API Configuration
API_BASE_URL = "http://localhost:2600"
...
def main():
    parser = argparse.ArgumentParser(description="Test AudioLDM Evaluation API")
    parser.add_argument("--api-url", default="http://localhost:2600", help="API base URL")
